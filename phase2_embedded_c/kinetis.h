...
enum {
    ...
    IRQ_DMA_ERROR               ,
    IRQ_MCM                     ,
    IRQ_FLASH_CMD_COMPLETE      ,
    IRQ_FLASH_READ_COLLISION    ,
    IRQ_MODE_CONTROLLER         ,
    IRQ_LOW_LEAKAGE_WAKEUP      ,
    IRQ_WATCHDOG                ,
    IRQ_RANDOM_NUMBER_GENERATOR ,
    IRQ_I2C0                    ,
    IRQ_I2C1                    ,
    IRQ_SPI0                    ,
    IRQ_SPI1                    ,
    IRQ_SPI2                    ,
    IRQ_CAN0_ORED_MSG_BUFFER    ,
    IRQ_CAN0_BUFFER_OFF         ,
    IRQ_CAN0_ERROR              ,
    IRQ_CAN0_TX_WARNING         ,
    IRQ_CAN0_RX_WARNING         ,
    ...
    IRQ_CAN1_IMEU               ,
    IRQ_CAN1_LOST_RX            ,
    IRQ_UART0_STATUS_SOURCES    ,
    IRQ_UART0_ERROR_SOURCES     ,
    IRQ_UART1_STATUS_SOURCES    ,
    IRQ_UART1_ERROR_SOURCES     ,
    IRQ_UART2_STATUS_SOURCES    ,
    IRQ_UART2_ERROR_SOURCES     ,
    IRQ_UART3_STATUS_SOURCES    ,
    IRQ_UART3_ERROR_SOURCES     ,
    IRQ_UART4_STATUS_SOURCES    ,
    IRQ_UART4_ERROR_SOURCES     ,
    IRQ_UART5_STATUS_SOURCES    ,
    IRQ_UART5_ERROR_SOURCES     ,
    IRQ_ADC0                    ,
    IRQ_ADC1                    ,
    IRQ_CMP0                    ,
    IRQ_CMP1                    ,
    ...
    IRQ_PDB                     ,
    IRQ_USB_OTG                 ,
    IRQ_USB_CHARGER_DETECT      ,
    IRQ_ENET_MAC_1588_TIMER     ,
    IRQ_ENET_MAC_TX             ,
    IRQ_ENET_MAC_RX             ,
    IRQ_ENET_MAC_ERROR          ,
    IRQ_I2S                     ,
...
#define NVIC_IP_BASE_ADDR  0xE000E400
