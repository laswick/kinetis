 ...
 */
    ...
    .thumb_set _isr_low_leakage_wakeup,         _low_leak_irq_handler
...
_vector_table:
    ...
    /*
     * Kinetis Flash Configuration Field - MUST be placed at 0x400!
     */
...
_default_irq_handler:
    ...
    .align 2
    .thumb_func
    .set LLWU_F2_ADDR,    0x4007C006
    .set LLWU_F2_FLAG_P8, 0x01

_low_leak_irq_handler:
    push {r0, r1, lr}
    ldr r0, =LLWU_F2_FLAG_P8
    ldr r1, =LLWU_F2_ADDR
    strb r0, [r1]
    pop {r0, r1, lr}
    bx lr
