/*****************************************************************************
 * Control Registers for the Cortex M4
 * Refer the Cortex M4 TRM R0P1 (Arm Doc DDI0439C)
 ****************************************************************************/
#ifndef __ARM_CM4
#define __ARM_CM4
#ifndef __ASM_SRC__
...
typedef struct SCR_MAP {
    ...
    uint32_t ACTRL;     /* 0xE008 Auxillary Control */
    uint32_t STCSR;     /* 0xE010 SysTick Control and Status */
    uint32_t STRVR;     /* 0xE014 SysTick Reload Value */
    uint32_t STCVR;     /* 0xE018 SysTick Current Value */
    uint32_t SCTR;      /* 0xE01C SysTick Calibration Value */
    uint32_t _RESERVED_1[825];
    uint32_t CPUID;     /* 0xED00 CPUID Base */
    uint32_t ICSR;      /* 0xED04 Interrupt Control and State */
    uint32_t VTOR;      /* 0xED08 Vector Table Offset */
} volatile *SCR_PTR;
#define SCR_BASE_ADDR 0xE000E000

#define SCR_REG(x) ((SCR_PTR)SCR_BASE_ADDR)->x
#endif
#endif
